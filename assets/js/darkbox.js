...
var $imagesGroup;
var $n = 0; // number of images
var $c = 0; // current image index (counter 0-based)
...
function showImage() {
  ...
  $("#darkbox_description").html(description);
  $("#darkbox_stats").html($n < 2 ? "" : ($c + 1) + "/" + $n);
